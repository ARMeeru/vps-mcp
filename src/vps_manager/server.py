...
from .config import load_config, VPSManagerConfig
...
class MCPVPSServer:
    ...
    def _setup_handlers(self) -> None:
            ...
            for server_config in self.config.servers:
                resources.append(
                    Resource(
                        ...
                        description=f"Connection to {server_config.host}:{server_config.port}",
        ...
        async def handle_read_resource(uri: str) -> str:
            ...
            try:
                system_status = await self.monitoring_tool.get_system_status(server_name)
        ...
        async def handle_list_tools() -> list[Tool]:
            ...
            return [
                Tool(
                    name="exec_command",
                    description="Execute shell commands on VPS servers with security validation",
                    inputSchema={
                        "type": "object",
                        "properties": {
                            "command": {
                            ...
                            "server": {
                                "type": "string",
                                "description": "Target server name (optional, uses first available if not specified)"
                            },
                            "timeout": {
                                "type": "integer",
                ...
                Tool(
                    ...
                    inputSchema={
                        ...
                        "properties": {
                            ...
                            "pattern": {
                                "type": "string",
                                "description": "Filter services by name pattern (regex)"
                            }
                        },
                        "required": []
                    }
        ...
        async def handle_call_tool(name: str, arguments: dict) -> list[TextContent]:
            ...
            try:
                ...
                valid_tools = {
                    "exec_command", "read_file", "write_file", "upload_file", 
                    "download_file", "get_system_status", "service_control", 
                    "list_services", "get_service_logs"
                }
                ...
                if name not in valid_tools:
                    error = VPSManagerError(
                        ...
                        user_action=f"Available tools: {', '.join(sorted(valid_tools))}",
                        operation=name,
                ...
                if isinstance(result, dict) and result.get("error"):
                    ...
                    result_text = json.dumps(success_response, indent=2, ensure_ascii=False)
    ...
    async def _execute_tool(self, name: str, arguments: dict, available_servers: list) -> Any:
    ...
    async def initialize(self) -> None:
        ...
        logger.info(f"Initialized {len(self.connection_manager.pools)} server connections")
