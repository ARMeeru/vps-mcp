...
class MCPResponse:
    ...
    @staticmethod
    def service_logs_result(
        service: str, logs: str, lines_returned: int, server: str = None
    ) -> Dict[str, Any]:
        """
